...
public class PuzzleView extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        selectedLineColor =
                ta.getColor(R.styleable.PuzzleView_selected_line_color, ContextCompat.getColor(getContext(), R.color.puzzle_piece_selected_line_color));
        handleBarColor =
                ta.getColor(R.styleable.PuzzleView_handle_bar_color, ContextCompat.getColor(getContext(), R.color.puzzle_piece_selected_boldline_color));
