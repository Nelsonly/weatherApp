...
//        albumModel.query(this, null);
    ...
    public void onClick(View view) {
        ...
        if (R.id.iv_back == id) {
            ...
            PuzzleActivity.startWithPhotos(this, selectedPhotos, Environment.getExternalStorageDirectory().getAbsolutePath() + "/" + Setting.appName, "IMG", Code.REQUEST_PUZZLE, false, Setting.imageEngine);
