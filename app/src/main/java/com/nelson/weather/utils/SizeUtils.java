...
public final class SizeUtils {
    ...
    /**
     * 设置字体大小
     * @param textsize,text,start,end
     * @return spannableString
     **/
    public static SpannableString changeWord(int textsize,String text,int start,int end){
        SpannableString spannableString=new SpannableString(text);
        spannableString.setSpan(new AbsoluteSizeSpan(textsize),start,end, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
        return spannableString;
    }
