...
public class SpeechUtil {
    ...
    private static void setParam() {
        ...
        if (mEngineType.equals(SpeechConstant.TYPE_CLOUD)) {
            ...
            //获取缓存值
            voicer = SPUtils.getString(com.nelson.weather.utils.Constant.VOICE_NAME, "xiaoyan", mContext);
            speedValue = SPUtils.getString(com.nelson.weather.utils.Constant.SPEED, "50", mContext);
            pitchValue = SPUtils.getString(com.nelson.weather.utils.Constant.PITCH, "50", mContext);
            volumeValue = SPUtils.getString(com.nelson.weather.utils.Constant.VOLUME, "50", mContext);
    ...
    private static void parsingResult(RecognizerResult results) {
        //获取解析结果
        String text = com.nelson.weather.utils.JsonParser.parseIatResult(results.getResultString());
