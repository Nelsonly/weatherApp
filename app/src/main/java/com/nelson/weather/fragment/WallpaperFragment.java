...
import com.nelson.weather.contract.WallPaperContract;
import com.nelson.weather.R;
import com.nelson.weather.ui.ImageActivity;
import com.nelson.weather.utils.CameraUtils;
...
import com.nelson.weather.utils.photopicker.PhotoPickerUtils;
...
import static com.nelson.weather.utils.Constant.SELECT_PHOTO;

public class WallpaperFragment extends MvpFragment<WallPaperContract.WallPaperPresenter>  implements WallPaperContract.IWallPaperView{
    /**
     * 标题
     */
    ...
    private void initWallPaperList() {
        ...
        mAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            ...
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (position == 0 ){
                    PhotoPickerUtils.pickPhotosForPuzzleUsingUri(getActivity());
                }else if( position == mList.size() - 1) {//是否为第一条或者最后一条
            ...
            case SELECT_PHOTO:
                if (resultCode == RESULT_OK) {
                    ...
                    if (Build.VERSION.SDK_INT > Build.VERSION_CODES.KITKAT) {
                        //4.4及以上系统使用这个方法处理图片
                        imagePath = CameraUtils.getImgeOnKitKatPath(data, getContext());
                    } else {
